...
python3 ../py-modules/py-tests/test-centurion.py

echo -e "${GREEN}Testing Centurion Add/Remove $NC"
python3 ../py-modules/py-tests/test-centurion-add-remove.py

echo -e "${GREEN}Reseting Test Database $NC"
mysql -uroot -proot cartonBotTest < ./schema-test.sql

echo -e "${GREEN}Testing Ganon $NC"
python3 ../py-modules/py-tests/test-ganon.py

echo -e "${GREEN}Reseting Test Database $NC"
mysql -uroot -proot cartonBotTest < ./schema-test.sql

echo -e "${GREEN}Testing Hammer $NC"
python3 ../py-modules/py-tests/test-hammer.py

echo -e "${GREEN}Testing Scribe $NC"
python3 ../py-modules/py-tests/test-scribe.py
